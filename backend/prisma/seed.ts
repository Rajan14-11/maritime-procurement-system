import { PrismaClient, UserRole, UserStatus, VesselStatus, VendorStatus, PrPriority, PrStatus, RfqStatus } from '@prisma/client';
...
async function main() {
  ...
  // 5. Seed Historical / Initial PRs so the dashboard feels alive
  console.log('Seeding Initial PRs & Workflows...');

  // PR-1002: Approved Safety Gear on MV Neptune
  ...
  // PR-1003: RFQ Created on MV Atlantic for Marine Lubricant
  ...
  // PR-1004: Pending Approval on MV Pacific
